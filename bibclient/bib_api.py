...
class HTBib(object):
    ...
    def request_single_record_json(self, id_type, id_value, full=False):
        ...
        mult_request = self.request_multi_record_json(id_dict, full=full)

        return mult_request[spec]
...
if __name__ == "__main__":
    ...
    # sspecs = [{"oclc":45678, "lccn":"70628581"}, {"id":"1", "oclc":"45678", "lccn":"70628581"},{"id":"2", "oclc":"45678", "lccn":"70628581"}]
    # print sspecs
    # print json.dumps(json.load(bquery.retrieve_request(bquery._multi_id_url(sspecs, full=True))), indent=4)
